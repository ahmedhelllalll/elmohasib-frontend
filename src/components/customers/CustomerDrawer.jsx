...
const CustomerDrawer = ({ isOpen, onClose, editingCustomer, onSave, isLoading }) => {
                ...
                <div className="flex items-center justify-between p-6 border-b border-slate-100">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">
                            {editingCustomer ? 'قم بتحديث بيانات العميل الحالي' : 'أدخل بيانات العميل الجديد لربطه بالمبيعات'}
                        </p>
                    </div>
                    <button 
                        onClick={onClose}
